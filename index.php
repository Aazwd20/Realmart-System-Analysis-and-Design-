...
<head>
    ...
    <link rel="stylesheet" href="Chatbot/css/bot.css">
</head>
	      ...
	      <section class="content">
	        <div class="row">
	        	<div class="col-sm-9">
		            ...
		            <h2>Monthly Top Selling Products</h2>
						<!-- Main content -->
						<section class="content">
	        <div class="row">
	        	<div class="col-sm-12">
	        	...
	        	<div class="col-sm-3">
					...
					<!-- <div class="livechat">
							<?php
								...
								// 	echo "<a href="livechat/chatbox.php"><button class = "button">
								// 	Live chat
								// 	</button></a>";
					...
					<div class="pic">
							<button class = "button" type='button' onclick="popup('chatbot-popup')">
							</button>
                </div>

                            <!-- popup -->

    <div class="popup-container" id="chatbot-popup">
    <div class="popup">
      <form method="POST" action="bot.php">
        
        <div id="container">
        <div id="screen">
            <button id="header" type="reset" onclick="popup('chatbot-popup')"><P>▼</P><H3>ONLINE CHATBOT</H3> </button>
